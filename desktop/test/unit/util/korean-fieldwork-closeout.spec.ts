...
describe('korean-fieldwork-closeout', () => {
    ...
    it('adds missing report metadata issues for photo records', () => {
    ...
    it('adds missing Field Hub upload issues for local tablet photo records', () => {
        ...
        const soilProfilePhoto = createDocument('soil-photo-1', 'SoilProfilePhoto', 'B soil', {
            soilProfilePhotoCapturedAt: '2026-06-23T01:02:03.000Z',
        ...
        const uploadedPhoto = createDocument('photo-2', 'Photo', 'C uploaded', {
            ...
            fieldworkImageUploadTarget: 'https://field.example/files/fieldwork/photo-2?type=original_image',
        ...
        const uploadedDrawing = createDocument('drawing-2', 'Drawing', 'E uploaded', {
            ...
            fieldworkImageUploadTarget: 'https://field.example/files/fieldwork/drawing-2?type=original_image',
            fieldworkImageUploadedProject: 'fieldwork',
            fieldworkImageUploadedSizeBytes: 481516,
    ...
    it('adds closeout review issues for tablet photo annotations without descriptions', () => {
        ...
        const annotatedSoilPhoto = createDocument('soil-photo-annotated', 'SoilProfilePhoto', 'Annotated soil', {
            soilProfilePhotoCapturedAt: '2026-06-23T01:02:03.000Z',
        ...
        const explainedPhoto = createDocument('photo-explained', 'Photo', 'Explained photo', {
            ...
            width: 4032,
            height: 3024,
            fieldworkPhotoAnnotationStrokes: '{"version":1,"strokes":[{"points":[{"x":2000,"y":2000}]}]}'
        });
    ...
    it('keeps tablet media in closeout when the upload target points to another file', () => {
        ...
        const wrongTargetUpload = createDocument('photo-1', 'Photo', 'A photo', {
            ...
            fieldworkImageUploadTarget: 'https://field.example/files/fieldwork/other-photo?type=original_image',
            fieldworkImageUploadedProject: 'fieldwork',
            fieldworkImageUploadedSizeBytes: 481516,
            fieldworkImageUploadedMd5: 'tablet-md5',
            fieldworkImageStoredSizeBytes: 481516,
